...
@section('content')
                    ...
                    <form id="ftthProjectForm" class="forms-sample" method="POST"
                            ...
                            <select class="form-control" id="type_id" name="type_id" required>
                                @foreach ($types as $type)
                                    <option value="{{ $type->id }}"
                                        {{ old('type_id', $ftthProject->type_id) == $type->id ? 'selected' : '' }}>
                                        {{ $type->type_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="project_name" name="project_name"
                                value="{{ old('project_name', $ftthProject->project_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="olt_hostname" name="olt_hostname"
                                value="{{ old('olt_hostname', $ftthProject->olt_hostname) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="no_sp2k_spa" name="no_sp2k_spa"
                                value="{{ old('no_sp2k_spa', $ftthProject->no_sp2k_spa) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="hp_plan" name="hp_plan"
                                value="{{ old('hp_plan', $ftthProject->hp_plan) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="hp_built" name="hp_built"
                                value="{{ old('hp_built', $ftthProject->hp_built) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fat_total" name="fat_total"
                                value="{{ old('fat_total', $ftthProject->fat_total) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fat_progress" name="fat_progress"
                                value="{{ old('fat_progress', $ftthProject->fat_progress) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fat_built" name="fat_built"
                                value="{{ old('fat_built', $ftthProject->fat_built) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="ip_olt" name="ip_olt"
                                value="{{ old('ip_olt', $ftthProject->ip_olt) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="kendala" name="kendala" rows="3" required>{{ old('kendala', $ftthProject->kendala) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="progress" name="progress"
                                value="{{ old('progress', $ftthProject->progress) }}" required>
                            ...
                            <select class="form-control" id="status_id" name="status_id" required>
                                @foreach ($statuses as $status)
                                    <option value="{{ $status->id }}"
                                        {{ old('status_id', $ftthProject->status_id) == $status->id ? 'selected' : '' }}>
                                        {{ $status->status_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="start_date" name="start_date"
                                value="{{ old('start_date', $ftthProject->start_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="target" name="target"
                                value="{{ old('target', $ftthProject->target) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="end_date" name="end_date"
                                value="{{ old('end_date', $ftthProject->end_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="radius" name="radius"
                                value="{{ old('radius', $ftthProject->radius) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="latitude" name="latitude"
                                value="{{ old('latitude', $ftthProject->latitude) }}" required>
                            @if ($errors->has('latitude'))
                                <span class="text-danger">{{ $errors->first('latitude') }}</span>
                            @endif
                            <input type="hidden" id="longitude" name="longitude"
                                value="{{ old('longitude', $ftthProject->longitude) }}" required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var initialLat = {{ old('latitude', $ftthProject->latitude) }};
            var initialLng = {{ old('longitude', $ftthProject->longitude) }};
            var initialRadius =
                {{ old('radius', $ftthProject->radius ?? 1000) }};
