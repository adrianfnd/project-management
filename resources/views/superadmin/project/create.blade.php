            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('project.store') }}" method="POST" class="p-4" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="is_active" name="is_active" required>
                                    ...
                                    <option value="N" {{ old('is_active') == 'N' ? 'selected' : '' }}>Tidak Aktif
                                    </option>
                                </select>
                            ...
                            <button type="submit" class="btn btn-primary mr-2" style="margin-right: 10px">Tambah
                                Project</button>
