    ...
    <div class="container-fluid py-4">
        <div class="row mb-4">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Form Edit Maintenance</h4>
                        <form action="{{ route('maintenance.update', $user->id) }}" method="POST" class="p-4">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-primary mr-2" style="margin-right: 10px">Update
                                Maintenance</button>
                            <a href="{{ route('maintenance.index') }}" class="btn btn-light">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
