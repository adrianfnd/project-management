...
<head>
  ...
  <link href="{{asset('ui_dashboard')}}/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="{{asset('ui_dashboard')}}/assets/css/soft-ui-dashboard.css?v=1.0.7" rel="stylesheet" />
      ...
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg blur blur-rounded top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid pe-0">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="{{asset('ui_dashboard')}}/pages/dashboard.html">
              Project Management
            </a>
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto ms-xl-auto me-xl-7">
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center me-2 active" aria-current="page" href="{{asset('ui_dashboard')}}/pages/dashboard.html">
          ...
          <div class="row">
                ...
                <div class="card-body">
                  <form role="form">
                    ...
                    <div class="text-center">
                        <a href="{{ route('dashboard') }}" class="btn bg-gradient-info w-100 mt-4 mb-0">Sign in</a>
                    </div>
                  </form>
                </div>
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('{{asset('ui_dashboard')}}/assets/img/curved-images/curved6.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
