...
class MaintenanceRiwayatController extends Controller
{
    public function index()
    {
        ...
        return view('maintenance.riwayat.index', compact('page_name', 'riwayatSuratJalans'));
    }
    ...
    public function show($id)
    {
        ...
        return view('maintenance.riwayat.view', compact('page_name', 'riwayat'));
    }
